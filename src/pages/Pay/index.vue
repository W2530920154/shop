  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a href="javascript:;" class="btn" @click="payNow">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    async getPay() {
      const result = await this.$API.apiPayMent(this.$route.params.orderId);
      if (result.code === 200) {
