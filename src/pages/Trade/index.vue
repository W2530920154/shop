  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="detail.imgUrl" alt="" style="width:100px;heigt:100px" />
          </li>
          <li>
            <p>
              {{ detail.skuName }}
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ defultAddress.userAddress }}</span>
        收货人：<span>{{ defultAddress.consignee }}</span>
        <span>{{ defultAddress.phoneNum }}</span>
      </div>
    </div>
